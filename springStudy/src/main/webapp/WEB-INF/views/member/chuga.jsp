...
<form name="dirForm">
	<table border="1" align="center" width="80%">
		...
		<tr>
			<td>성별</td>
			<td>
				<input type="radio" name="gender" value="M" checked onclick="suntaek_gender('M');"> 남자&nbsp;&nbsp;&nbsp;
				<input type="radio" name="gender" value="F" onclick="suntaek_gender('F');"> 여자
...
$(document).ready(function(){
   ...
   $("#btnList").click(function(){
	...
	function id_check_win() {
		window.open("${path}/member_servlet/id_check_win.do", "새창이름", "width=640, height=480, toolbar=no, menubar=no, scrollbars=no, resizable=yes");
	}
</script>
